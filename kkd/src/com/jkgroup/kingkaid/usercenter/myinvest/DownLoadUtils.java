...
public class DownLoadUtils {
	...
	public static HSSFWorkbook getrtnPlanHSSFWorkBook(List<FormData> list){
		...
		HSSFSheet sheet = workbook.createSheet(); 
		{
		 ...
		 title.createCell(cellIndex++).setCellValue("期次");
		 title.createCell(cellIndex++).setCellValue("还款日期");
		 title.createCell(cellIndex++).setCellValue("应还本息");
		 title.createCell(cellIndex++).setCellValue("应还本金");
		 title.createCell(cellIndex++).setCellValue("应还利息");
		 title.createCell(cellIndex++).setCellValue("贷款余额");
		}

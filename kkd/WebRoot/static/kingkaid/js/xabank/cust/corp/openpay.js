$(document).ready(function() {
	...
	$("#openpayForm").click(function() {
		
		if (openpayForm.element($("#filter_custname")) 
    			&& openpayForm.element($("#filter_inducate"))
    			&& openpayForm.element($("#filter_regamt"))
    			&& openpayForm.element($("#filter_leadcustname"))
    			&& openpayForm.element($("#filter_leadphone"))
    			&& openpayForm.element($("#filter_leadcustpaperid"))
    			&& openpayForm.element($("#filter_threeinone"))
    			&& openpayForm.element($("#filter_orgaid"))
    			&& openpayForm.element($("#filter_creveid"))
    			&& openpayForm.element($("#filter_lreveid"))
    			&& openpayForm.element($("#filter_instcredit"))
    			&& openpayForm.element($("#filter_instcreditenddate"))
    			&& openpayForm.element($("#filter_instcreditdate"))
    			&& openpayForm.element($("#filter_comporg"))
    			&& openpayForm.element($("#filter_isinner"))
    			&& openpayForm.element($("#filter_appno"))){

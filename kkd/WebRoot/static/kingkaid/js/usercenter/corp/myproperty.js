 $(document).ready(function(){
	 $.ajax({
    	 ...
    	 $("#pager").simplePagination({
    		url : ctx+'/auth/usercenter/acctdetail.html',
 	        items_per_page : 8,
 	...
 	/*function showDeleteCard(){
 		create_bg();
 	     ...
 	     InfoLookehtml ='<div class="alert_box_small" style="width:400px;margin-left:-230px;">'
 	              ...
 	              +'           <div style="float:left;width:400px;"><span style="display:block;width:100px;position:absolute;text-align:right;font-size:16px;">银行卡号：</span><input type="text" value="'+trim($("#bankacno_str").html())+'" class="window_input" style="margin-left:100px;width:240px;height:30px;font-weight:bold;font-size:16px;color:#669;padding-left:10px;" readonly/></div>'
 	              +'         </div>'
 	              +'         <div style="overflow:hidden;margin-bottom:20px;padding:0 0 5px 5px;">'
 	              +'           <div style="float:left;width:400px;"><span style="display:block;width:100px;position:absolute;text-align:right;font-size:16px;">银行名称：</span><input type="text" value="'+trim($("#bankname_str").html())+'" class="window_input" style="margin-left:100px;width:240px;height:30px;font-weight:bold;font-size:16px;color:#669;padding-left:10px;" readonly/></div>'
 	              +'         </div>'
 	             +'         <div style="overflow:hidden;margin-bottom:20px;padding:0 0 5px 5px;">'
	              +'           <div style="float:left;width:400px;"><span style="display:block;width:100px;position:absolute;text-align:right;font-size:16px;">交易密码：</span><input type="password" name="transpwd_delcard" id="transpwd_delcard" value="" class="window_input" style="margin-left:100px;width:240px;height:30px;font-weight:bold;font-size:16px;color:#669;padding-left:10px;"/></div>'
	              +'         </div>'
 	              +'       </div>'
 	              +'   </div>'
 	...
 	/*function ctp_addbankcard_up() {
 	     ...
 	     InfoLookehtml ='<div class="alert_box_small" style="width:900px;margin-left:-430px;">'
 	              ...
 	              +'       <div class="operate_content" style="width:auto;">'
 	              +'         <div style="overflow:hidden;margin-bottom:20px;padding:0 0 5px 5px;">'
 	              +'           <div style="float:left;width:400px;"><span style="display:block;width:100px;position:absolute;text-align:right;font-size:16px;">银行卡号：</span><input type="text" name="bankcode_up" id="bankcode_up" value="" class="window_input" style="margin-left:100px;width:240px;height:30px;font-weight:bold;font-size:16px;color:#669;padding-left:10px;" onchange="ctp_cardcertify_up();"/></div>'
 	              ...
 	              +'           <div style="float:left;width:400px;"><span style="display:block;width:100px;position:absolute;text-align:right;font-size:16px;">银行名称：</span><input type="text" name="bankname_up" id="bankname_up" value="" class="window_input" readonly style="margin-left:100px;width:240px;height:30px;font-weight:bold;font-size:16px;color:#669;padding-left:10px;border:none;"/></div>'
 	              ...
 	              +'   </div>'
 	              +'   <div class="small_window_bottom" style="padding-top:10px;">'
 	              +'       <div class="blue_btn" style="float:left;margin-left:30px;width:260px;" onclick="ctp_openPay_by_xabank()">绑定银行卡</div>'
 	              +'   </div>'
 	              +'</div>';
 	         visual.innerHTML = InfoLookehtml;
 	     document.body.appendChild(visual);

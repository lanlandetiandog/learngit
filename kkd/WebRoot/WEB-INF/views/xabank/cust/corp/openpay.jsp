...
<script type="text/javascript" src="${ctx}/static/kingkaid/js/xabank/cust/corp/openpay.js"></script>
<title>金开贷</title>
...
<body>
	<div class="header">
		<div style="height: 84px; width: 1000px; margin: 0 auto;">
			...
			<div
				style="float: right; font-weight: bold; font-size: 20px; margin-top: 40px;">账户认证</div>
		</div>
	</div>
	...
	<div class="xianlogobox wd9 mg0">
		...
		<div class="bkxiantext fl-l mg-l40">企业电子支付账户认证</div>
	</div>
	<div style="clear: both;"></div>
	<!--1.企业基本信息-->
	<form id="openpayForm" action="openpaycorp.html" method="post">
		...
		<div class="basicinfo3 wd9 mg0 bod1">
			...
			<div class="basic-left fl-l mg-l40 mg-t28">
				...
				<div class="cominput-radio">
					<p>是否三证合一</p>
					<div class="radiobox">
						<input id="filter_threeinone" type="radio" value="1" name="filter_threeinone"/>是 
						<input id="filter_threeinone" type="radio" value="0" name="filter_threeinone"/>否
					</div>
					<div style="clear: both;"></div>
				</div>
				<!--info10-->
				<div class="cominput">
					<p>企业营业执照号</p>
					<input readonly="readonly" id="filter_orgaid" name="filter_orgaid" type="text" class="comlicense" placeholder="请输入企业营业执照号" value="${formData.orgaid}" />
					<div style="clear: both;"></div>
				</div>
				<!--info11-->
				<div class="cominput">
		...
		<div class="wd9 mg0 mg-b40">
			<button class="subInfo" id="doSubmit">确认信息<span id="dotting"></span></button>
		</div>
		<div style="clear: both;"></div>
		<!--企业账户验证end-->
	</form>

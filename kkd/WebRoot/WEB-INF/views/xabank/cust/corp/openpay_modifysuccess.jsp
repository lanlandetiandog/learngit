            ...
            <c:choose>
               <c:when test="${respcode eq 'S'}">
                <div class="logotxt">
	                ...
	                <div class="txttip fl">
	                	<c:choose>
	                		<c:when test="${operateType eq '2'}">
			                	<div>
			                    	<span class="youxuc">您的西安银行账户开户信息已经更新！</span>
			                    </div>
			                    <span class="youhope">请通知您的项目经理重新上传证件照片以便成功开户</span>
		                    </c:when>
		                    <c:otherwise>
		                    	<div>
			                    	<span class="youxuc">您的西安银行账户开户申请已经撤销！</span>
			                    </div>
		                    </c:otherwise>
		                </c:choose>
	                </div>
                ...
                <div class="logotxt">
	                ...
	                <div class="txttip fl">
	                	<c:choose>
	                	  <c:when test="${operateType eq '2'}">
			                <div>
			                    <span class="youxuc">很遗憾您西安银行账户开户信息更新失败! 原因：${respdesc}</span>
			                </div>	   
	                      </c:when>
		                  <c:otherwise>
		                  	<div>
			                    <span class="youxuc">很遗憾您西安银行账户开户申请撤销失败! 原因：${respdesc}</span>
			                </div>  
		                  </c:otherwise>
		                </c:choose>             
	                </div>

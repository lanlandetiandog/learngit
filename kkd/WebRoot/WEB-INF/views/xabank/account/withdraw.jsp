...
<script type="text/javascript" src="${ctx}/static/kingkaid/js/xabank/account/withdraw.js"></script>
	                        ...
	                        <!-- 
	                         ...
	                         -->
	                            ...
	                            <span class="cash_info_left">手续费：</span>
	                                    ...
	                                    <span style="font-size:12px;margin-left:15px;">
	                                        <span id="servfee1">
		                                        ...
		                                        <c:choose>
		                                        	...
		                                        	<c:otherwise>（${chanfee.servfeevalue2}%每笔上限${chanfee.maxservfee2}元）</c:otherwise>
		                                        </c:choose>
	                                    	</span>
	                                ...
	                                <div class="remind">(温馨提示：VIP会员提现手续费5折优惠)</div>
	                            <div style="clear:both;"></div>
	                        </li>
	                        <li>

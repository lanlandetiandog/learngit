...
<script type="text/javascript" src="${ctx}/static/kingkaid/js/usercenter/myproperty.js"></script>
                        ...
                        <div style="float:right;padding-right:30px;">
                            <c:choose>
							    <c:when test="${user_obj.memberState eq '4' || user_obj.memberState eq '5'}">
							        <a class="top_charge" style="margin-bottom:21px;padding: 0 11px;margin-top: 23px;" href="${ctx}/auth/cust/openpay_page.html" target="_blank">立即开通</a>
							    </c:when>
							    <c:when test="${user_obj.memberState eq '6' || user_obj.memberState eq '7'}">
							        <a class="top_charge" style="margin-bottom:21px;padding: 0 11px;margin-top: 23px;" href="${ctx}/auth/cust/openpay_page.html" target="_blank">立即激活</a>
							    </c:when>
							    <c:otherwise>

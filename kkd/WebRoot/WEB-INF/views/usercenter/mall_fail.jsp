...
<div class="payment payment-real" style="min-height:515px;">
...
<!--提交成功-->
<div class="step3">
	<div class="sucfail" style="background:url(${ctx}/static/kingkaid/images/failednum.png) no-repeat top center ;background-size:contain;"></div>
    <div class="sucfailtxt">
    	<h3>兑换失败</h3>
         <span>您的产品兑换失败</span>
        <span>订单编号：${temp_thirdid} </span>
        <span>失败原因：${temp_errordesc} </span>
        <span>订单详情请在礼品商城-<a href="${ctx}/auth/usercenter/mallorder.html" style="color:#0066CC">我的订单</a>中查看</span>
    </div>
</div>
<c:if test="${temp_thirdid eq ''}">

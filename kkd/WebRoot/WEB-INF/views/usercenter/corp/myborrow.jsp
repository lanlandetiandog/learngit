...
<script type="text/javascript" src="${ctx}/static/kingkaid/js/usercenter/corp/myborrow.js"></script>
</head>
<body>
    ...
    <form action="${ctx}/auth/usercenter/returnplandownload.html" target="_blank" method="post" id="downloadreturnplanss">

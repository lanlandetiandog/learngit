...
<script type="text/javascript" src="${ctx}/static/kingkaid/js/usercenter/continfo.js"></script>
<title>金开贷合同浏览</title>
</head>
...
<body>
	...
	<div class="content" style="overflow: hidden;">
		<div class="protocal_content">
			...
			<div
				style="padding-top:45px;text-align:center;color:#ea6660;font-size:20px;font-weight:bold;background:url(${ctx}/static/kingkaid/images/pro_top_bg.jpg);width:1026px;height:55px;">借款合同</div>

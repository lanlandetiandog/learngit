...
<script type="text/javascript" src="${ctx}/static/kingkaid/js/project/projectrecordtwo.js"></script>
   ...
   <div class="content">
        <div class="content_box">
            ...
            <div class="recharge-top" style="padding:20px 34px">
                    <div class="recharge-title">担保记录</div>
                ...
                <table class="borrow-record-table">
                 <tr>
                        <td style="text-align:left"><span class="red_text">担保人：${map.dbcustname}</span></td>
                        <td><span>投标中</span></td>
                        <td><span>还款中</span></td>
                        <td><span>已结清</span></td>
                    </tr>

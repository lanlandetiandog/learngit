        ...
        <div class="content_box">
            <div class="content_detail_right">
                <div class="usercenter-title">
                    ...
                    <a href="activity_list.html" style="float:right;margin:13px 30px 0 0;font-size:14px;color:#ea6660;">   
                        返回列表&gt;&gt;
                    </a>
                </div>
                <div class="activity_detail">
                    <div class="act_detail_title">${activemovelist.activeid}</div>
                    <div class="act_detail_info">
                         <span>发布时间：<fmt:formatDate value="${activemovelist.optime}" pattern="yyyy年MM月dd日" /></span>
                    </div>
                    <div>${activemovelist.activeinfo}</div> 
                </div>

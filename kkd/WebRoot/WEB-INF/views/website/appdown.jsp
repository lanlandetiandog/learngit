...
.iosapp{
	...
	font-family: "微软雅黑";
	font-size: 14px;
	background:url(${ctx}/static/kingkaid/images/iOSappbanner.png) no-repeat top center;
...
<body>
    <div style="height:84px;width:1000px;margin:0 auto;">
        <a style="float:left;margin-top:20px;" href="${ctx}/"><img src="${ctx}/static/kingkaid/images/logo.png" /></a>

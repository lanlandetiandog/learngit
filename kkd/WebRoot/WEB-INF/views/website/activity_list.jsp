...
<script type="text/javascript">			 
	$(document).ready(function() {			 
	    $("#pager").simplePagination({	
	        url : '${ctx}/website/getActivitylist',
	        items_per_page : 10,
	        handle_data : function(dataObj,pageno) {
		    	$("#newlist_table").empty();				
		        	...
		        	rowContent=rowContent +'<li> <div class="list_style"></div>'+'<div class="list_name"></div>'	
		        	              	 	+'<a href="activity_detail.html?id='+dataObj.result[i].id+'">' + dataObj.result[i].activeid 
        ...
        <div class="content_box">
            <div class="content_detail_right">
                <div class="usercenter-title">
                    <div class="usertitle-text">平台活动</div>
           ...
           <!--      
                <ul class="news_list">
					 <c:forEach  begin="0" end="0" var="odata" items="${outData}">
						<li>
							<div class="list_style"></div>
							<div class="list_name">
								<a href="activity_detail.html?seqno=${odata.seqno}">${odata.activeid}</a>
								<img class="new_icon" src="${ctx}/static/kingkaid/images/new_icon.png" />
							</div>
							<div class="list_time"><fmt:formatDate value="${odata.optime}"  type="date" dateStyle="default" /></div>
						</li>
					</c:forEach>
					<c:forEach  begin="1" end="9" var="odata" items="${outDataing}">
						  <li>
							<div class="list_style"></div>
							<div class="list_name">
								<a href="activity_detail.html?seqno=${odata.seqno}">${odata.activeid}</a>

...
<body>
    ...
    <div class="login-content" >
        <div class="login_banner">
            <div class="login-box">
                ...
                <div class="login_area">
                    <div class="nlogin_title">
                        <div class="nlogin" onclick="nloginfun()" id="nlogin" style="color: #5d89c9; background: none;">登录</div>
                        <div class="login-line"></div>
                        <div class="nregis" onclick="nregisfun()" id="nregis" style="color: #999; background: url('${ctx}/static/kingkaid/images/log_bot.png') no-repeat bottom center;">注册</div>
                    </div>
                    ...
                    <form id="form_login" action="${ctx}/login" method="post">
	                    <shiro:authenticated>
			                <div class="login_area"  style="width:270px;">
			                   <c:set var="thirdPartyName" value="${user_obj.memberName}"/>
				                  <div class="login_title" style="font-weight:normal; margin-top:-30px;">${kkd:showPrivacy(thirdPartyName, 6)}，您的账号已登录！</div>
			           ...
			           <shiro:guest>
                        <div class="login-btn" id="login-btn" style="display: none;">
		                    <div id="errorMsg" style="color: #E7222B; font-size: 12px;">${errorMsg}</div>
                            <!--登录-->
                            <div class="input-unit">
                                <div style="width:290px;">
	                                <label class="name-label"> </label>
	                                <input id="username" name="username" type="text" class="login-input" placeholder="用户名/手机号码" tabindex='1'/>
                                </div>
                            ...
                            <div class="input-unit">
                            	<div style="width:290px;">
	                                ...
	                                <input id="password" name="password" type="password" class="login-input " placeholder="密码" tabindex='2'/>
                                </div>
                                <div class="error-msg"></div>
                            </div>
                            <div class="input-unit nlogin-unit-input">  
                            	<div>
	                                <input id="val_code" name="val_code" type="text" class="login-input" style="width:260px;" placeholder="请输入红色验证码" tabindex='3'/>
	                                <div class="code_img">
	                                	<img id="login_code_img" style="float:left; margin-top:2px" title="点击更换验证码" alt="验证码" src="${ctx}/getValidateCode?s=<%=new java.util.Date().getTime()%>" />
	                                </div>
	                               	<div class="error-msg"></div>
                               	</div>
                            </div>
                        ...
                        <!--注册-->
					<form id="form_register" action="${ctx}/member/register" method="post">
                        <shiro:guest>
                        <div class="register-btn" id="register-btn" style="display: block;">
                        	<div id="regErrorMsg" style="color: #E7222B; font-size: 12px;">${regErrorMsg}</div>
                            <div class="input-unit">
                                <div style="width: 285px;">
	                                <label class="psw-label-phone"> </label>
	                                <input type="text" id="filter_mobilenumber" name="filter_mobilenumber" tabindex="1" class="login-input" placeholder="手机号码"/>
                                </div>
                                <div class="error-msg"></div>
                            </div>
                            <div class="input-unit">
                                <div style="width: 285px;">
	                                <label class="psw-label"> </label>
	                                <input type="password" id="filter_loginpassword" name="filter_loginpassword" tabindex="2" class="login-input" placeholder="请设置密码"/>
                                </div>
                                <div class="error-msg"></div>
                            </div>

                            <div id="regis_numimg" class="input-unit nlogin-unit-input">
                                <input type="text" id="mvcode" name="mvcode" class="login-input" style="width:260px;" tabindex="3" placeholder="请输入红色验证码"/>
                                <div class="code_img">
                                	<img id="reg_code_img" style="float:left; margin-top:2px" title="点击更换验证码" alt="验证码" src="${ctx}/member/getVCodeValidateCode?s=<%=new java.util.Date().getTime()%>" />
                                </div>
                                <div class="error-msg"></div>
                            </div>
                            ...
                            <div class="input-unit">
	                            <div style="width: 285px;">
	                                <input id="filter_verifycode" name="filter_verifycode" class="login-input" tabindex="4" style="width:180px;" placeholder="短信验证码"/>
                            ...
                            <div class="nregis_input" >
                                <input id="filter_invitecode" name="filter_invitecode" class="nregis_in" placeholder="聚财码（选填）"/>
                                <div class="error-msg"></div>
                            </div>
                            <div style="clear: both;"></div>

                            <div class="logtxt">
                                <input type="checkbox" id="if_read_chkbox" name="if_read_chkbox" tabindex="5"/>
                                <span>我同意</span>
                                <a class="blue_link" href="protocol.html" target="_blank">金开贷会员服务协议</a>
                            	<div class="error-msg"></div>
                            </div>
                           	<input type="submit" id="btn_register" class="login_btn" style='width:100%; margin-bottom:40px; font-family: "微软雅黑","宋体",STHeiti,Verdana,Arial,Helvetica,sans-serif;' tabindex="6" value="注 册"/>
                  		</div>
                        </shiro:guest>
					</form>
                </div>
            ...
            <div class="login-two-code" style="display:none; color: #ea6660; font-size: 20px;">

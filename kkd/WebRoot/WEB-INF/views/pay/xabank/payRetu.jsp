        ...
        <div class="chargebox">
            <div class="chargeboxtop" style="height:62px;">
                <div style="float:left; margin:10px 8px 0;">
                    <c:choose>
                        ...
                        <c:when test="${transtat eq '1'}">
                            <img src="${ctx}/static/kingkaid/images/waiting.png"/>
                        </c:when>
                        <c:otherwise>
                ...
                <span>
                    <c:choose>
                        <c:when test="${transtat eq '0'}">
                            <p style="line-height:62px;font-size:32px;color:#666;float:left;display:block;">成功</p>
                        </c:when>
                        <c:when test="${transtat eq '1'}">
                            <p style="line-height:62px;font-size:32px;color:#666;float:left;display:block;">处理中</p>
                        </c:when>
                        <c:otherwise>
                            <p style="line-height:62px;font-size:32px;color:#666;float:left;display:block;">失败</p>
                        </c:otherwise>
                    </c:choose>
